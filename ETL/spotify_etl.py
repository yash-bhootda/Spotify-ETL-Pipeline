...
def spotify_etl_func():
    ...
    # conn = psycopg2.connect(host="localhost", user="postgres" , password="yrm222829", port="5432", dbname="yrb")
    # cur = conn.cursor()
    # engine = create_engine('postgresql+psycopg2://postgres:yrm222829@localhost/yrb')
